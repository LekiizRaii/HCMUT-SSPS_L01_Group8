            ...
            <div id="history1">
                <div class="m-auto w-full lg:max-w-full p-6 bg-white rounded-lg shadow-xl :dark:bg-gray-800">
                    <div class="flex flex-row">
                        ...
                        <h2 class="ms-auto me-3 font-medium text-xl">ID: 2110896</h2>
                    </div>
                    ...
                    <div class="flex flex-col items-center relative overflow-x-auto shadow-md sm:rounded-lg">
                            ...
                            <tbody>
                                <tr
                                    ...
                                    <th scope="row" class="flex flex-col px-6 py-4  whitespace-nowrap :dark:text-white">
                                        <p class="my-auto font-thin text-blue-600">BiKipTanGaiDaiCuong.pdf</p>
                                        <p class="my-1 font-thin text-gray-900">Number of Pages: 69, Size: A4</p>
                                    </th>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Printer#1
                                    </td>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Sep 11, 2023 13:43:54
                                    </td>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Sep 11, 2023 13:45:10
                                    </td>
                                ...
                                <tr
                                    class="bg-white border-b :dark:bg-gray-800 :dark:border-gray-700 hover:bg-gray-50 :dark:hover:bg-gray-600">
                                    <th scope="row" class="flex flex-col px-6 py-4  whitespace-nowrap :dark:text-white">
                                        <p class="my-auto font-thin text-blue-600">PhaoCuoiKiCNPM.pdf</p>
                                        <p class="my-1 font-thin text-gray-900">Number of Pages: 3, Size: A5</p>
                                    </th>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Printer#1
                                    </td>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Apr 01, 2023 19:33:18
                                    </td>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Apr 01, 2023 19:34:01
                                    </td>
                                    <td class="px-6 py-4 text-center text-green-500">
                                        Success
                                    </td>
                                ...
                                <tr
                                    class="bg-white border-b :dark:bg-gray-800 :dark:border-gray-700 hover:bg-gray-50 :dark:hover:bg-gray-600">
                                    <th scope="row" class="flex flex-col px-6 py-4  whitespace-nowrap :dark:text-white">
                                        <p class="my-auto font-thin text-blue-600">DonXinNghiHocBachKhoa.docx</p>
                                        <p class="my-1 font-thin text-gray-900">Number of Pages: 1, Size: A4</p>
                                    </th>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Printer#1
                                    </td>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Jan 11, 2023 18:13:24
                                    </td>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Jan 11, 2023 18:13:40
                                    </td>
                                    <td class="px-6 py-4 text-center text-green-500">
                                        Success
                                    </td>
                                ...
                                <tr
                                    class="bg-white border-b :dark:bg-gray-800 :dark:border-gray-700 hover:bg-gray-50 :dark:hover:bg-gray-600">
                                    <th scope="row" class="flex flex-col px-6 py-4  whitespace-nowrap :dark:text-white">
                                        <p class="my-auto font-thin text-blue-600">300BaiCodeThieuNhi.pdf</p>
                                        <p class="my-1 font-thin text-gray-900">Number of Pages: 696, Size: A4</p>
                                    </th>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Printer#1
                                    </td>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Nov 23, 2022 06:09:34
                                    </td>
                                    <td class="px-6 py-4 text-gray-600 text-center">
                                        Nov 23, 2022 06:30:29
                                    </td>
                                    <td class="px-6 py-4 text-center text-green-500">
                                        Success
                                    </td>
                        ...
                        dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">See more</button>
                    </div>
                </div>
            </div>
            <div id="history2">
                <div class="m-auto w-full lg:max-w-full p-6 bg-white rounded-lg shadow-xl :dark:bg-gray-800">
                    <div class="flex flex-row">
                        ...
                        <form class="mx-auto flex flex-row">
                                <input type="email" id="email" class="ms-20 bg-gray-50 border border-gray-300 
            ...
            <div id="history3">
                <div class="m-auto w-full lg:max-w-full p-6 bg-white rounded-lg shadow-xl :dark:bg-gray-800">
                    <div class="flex flex-row">
                        ...
                        <form class="mx-auto flex flex-row">
                                <input type="text" id="ID" class="ms-20 bg-gray-50 border border-gray-300 
                                text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                                :dark:bg-gray-700 :dark:border-gray-600 :dark:placeholder-gray-400 :dark:text-white 
                                :dark:focus:ring-blue-500 :dark:focus:border-blue-500" placeholder="Enter student’s ID or printer ID" required>
                                <button type="submit" id="submitID" name="submitID" class="p-2.5 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
                                    </svg>
                                    <span class="sr-only">Search</span>
