...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <div id="homepage1">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center">
            ...
            <a href="../history/history.html" class="rounded-4xl py-2 px-16 bg-white my-5 md:mx-10 xl:mx-16 hover:bg-blue-400 border-2 border-gray-500 w-9/12 md:w-6/12 lg:w-5/12 xl:w-4/12" style="border-radius: 40px;">
    ...
    <div id="homepage2">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center">
            ...
            <a href="../report/report.html" class="rounded-4xl py-2 px-16 bg-white my-5 md:mx-10 xl:mx-16 hover:bg-blue-400 border-2 border-gray-500 w-9/12 md:w-6/12 lg:w-5/12 xl:w-4/12" style="border-radius: 40px;">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center">
            <a href="../settingspage/settingspage.html" class="rounded-4xl py-2 px-16 bg-white my-5 md:mx-10 xl:mx-16 hover:bg-blue-400 border-2 border-gray-500 w-9/12 md:w-4/12 lg:w-3/12 xl:w-3/12" style="border-radius: 40px;">
            ...
            <a href="../management/managementDefault.html" class="rounded-4xl py-2 px-16 bg-white my-5 md:mx-10 xl:mx-16 hover:bg-blue-400 border-2 border-gray-500 w-9/12 md:w-4/12 lg:w-3/12 xl:w-3/12" style="border-radius: 40px;">
